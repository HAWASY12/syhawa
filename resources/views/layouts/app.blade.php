            ...
            @if (isset($header))
                <header class="bg-white dark:bg-gray-800 shadow">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('candidat.index')}}">Formation</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('candidat.index')}}">Types</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('candidat.index')}}">Referentiel</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link bg-success" href="{{route('login')}}">Se connecter</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link bg-warning" href="{{route('register')}}">S'inscrire</a>
                        </li>
                        </ul>
                </header>
            @endif
